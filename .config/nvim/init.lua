...
map(
	"n",
	"<leader>b",
	"<cmd>Telescope buffers workspace=CWD theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Buffers" }
)
map(
	"n",
	"<leader>g",
	"<cmd>Telescope live_grep workspace=CWD theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Search" }
)
map(
	"n",
	"<leader>f",
	"<cmd>Telescope frecency workspace=CWD theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Files" }
)
map(
	"n",
	"<leader>j",
	"<cmd>Telescope frecency theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Global files" }
)
map(
	"n",
	"<leader>r",
	"<cmd>Telescope oldfiles workspace=CWD theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Recent files" }
)
map(
	"n",
	"<leader>h",
	"<cmd>Telescope help_tags workspace=CWD theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Help" }
)
map(
	"n",
	"<leader>es",
	"<cmd>Telescope spell_suggest workspace=CWD theme=ivy previewer=false shorten_path=true<cr>",
	{ desc = "Spell" }
)
...
local on_attach = function(_, bufnr)
	...
	map("n", "K", vim.lsp.buf.hover, { buffer = bufnr, desc = "vim.lsp.buf.hover()" })
end

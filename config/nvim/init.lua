...
map("n", "<leader>ls", ivy(builtin.lsp_document_symbols), { desc = "LSP document dymbols" })
map("n", "<leader>lw", ivy(builtin.lsp_workspace_symbols), { desc = "LSP eorkspace dymbols" })
...
local on_attach = function(_, bufnr)
	map("n", "grd", ivy(vim.lsp.buf.definition), { buffer = bufnr, desc = "Go to definition" })
	map("n", "grD", ivy(vim.lsp.buf.declaration), { buffer = bufnr, desc = "Go to declaration" })
	map("n", "grh", ivy(vim.lsp.buf.hover), { buffer = bufnr, desc = "Hover documentation" })
end
local lsp_servers = {

...
vim.pack.add({
  ...
  -- { src = "https://github.com/nvim-neotest/nvim-neo" },
...
map("n", "<leader>f", "<cmd>Telescope frecency workspace=CWD theme=ivy previewer=false<cr>", { desc = "Files" })
map("n", "<leader>j", "<cmd>Telescope frecency theme=ivy previewer=false<cr>", { desc = "Global files" })
...
-- map("n", "<leader>dj", dap.step_over, { desc = "New" })
...
-- neotest.setup()
-- map("n", "<leader>tr", neotest.run.run(), { desc = "Run nearest" })
-- map("n", "<leader>tf", neotest.run.run(vim.fn.expand("%")), { desc = "Run file" })
-- map("n", "<leader>ta", neotest.run.run(vim.uv.cwd()), { desc = "Run all" })
-- map("n", "<leader>tl", neotest.run.run_last(), { desc = "Run last" })
-- map("n", "<leader>ts", neotest.summary.toggle(), { desc = "Toggle summary" })
-- map("n", "<leader>to", neotest.output.open({ enter = true, auto_close = true }), { desc = "Show ouput" })
-- map("n", "<leader>tw", neotest.watch.toggle(vim.fn.expand("%")), { desc = "Toggle watch" })
